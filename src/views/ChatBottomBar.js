...
export default class ChatBottomBar extends Component {
    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity activeOpacity={0.5} onPress={this.handlePress.bind(this, "soundBtn")}>
          <Image style={styles.icon} source={require('../../img/wechat/ic_chat_sound.png')}/>
        </TouchableOpacity>
        ...
        <TouchableOpacity activeOpacity={0.5} onPress={this.handlePress.bind(this, "emojiBtn")}>
          <Image style={styles.icon} source={require('../../img/wechat/ic_chat_emoji.png')}/>
        </TouchableOpacity>
        {
          Utils.isEmpty(this.state.inputMsg) ? (
            <TouchableOpacity activeOpacity={0.5} onPress={this.handlePress.bind(this, "moreBtn")}>
              <Image style={[styles.icon, {marginLeft: 10}]} source={require('../../img/wechat/ic_chat_add.png')}/>
            </TouchableOpacity>
          ) : (
  ...
  renderRecorderView() {
    return (
      <View style={styles.container}>
        <TouchableOpacity activeOpacity={0.5} onPress={this.handlePress.bind(this, "soundBtn")}>
          <Image style={styles.icon} source={require('../../img/wechat/ic_chat_keyboard.png')}/>
        </TouchableOpacity>
