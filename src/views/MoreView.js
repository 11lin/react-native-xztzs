...
const icons = [
  require('../../img/wechat/ic_more_card.png'),
  require('../../img/wechat/ic_more_take_pic.png'),
  require('../../img/wechat/ic_more_recorder.png'),
  require('../../img/wechat/ic_more_position.png'),
  require('../../img/wechat/ic_more_movie.png'),
  require('../../img/wechat/ic_more_phone.png'),
  require('../../img/wechat/ic_more_gallery.png'),
  require('../../img/wechat/ic_more_collection.png'),
];
