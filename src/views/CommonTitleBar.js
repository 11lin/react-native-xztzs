...
export default class CommonTitleBar extends Component {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <TouchableOpacity activeOpacity={0.5} onPress={this.handleBackClick}>
            <Image source={require('../../img/wechat/ic_back.png')} style={styles.backBtn}/>
          </TouchableOpacity>
  ...
  renderIOS() {
    return (
      <View style={styles.container}>
        <View style={{height: 20, backgroundColor: HelperColors.titleBackgroundColor}}/>
        <View style={styles.content}>
          <TouchableOpacity activeOpacity={0.5} onPress={this.handleBackClick}>
            <Image source={require('../../img/wechat/ic_back.png')} style={styles.backBtn}/>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  content: {
    width: width,
    height: 50,
    backgroundColor: HelperColors.titleBackgroundColor,
    flexDirection: 'row',
    alignItems: 'center'
  },
  backBtn: {
